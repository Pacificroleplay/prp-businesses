...
QBCore.Functions.CreateCallback('prp-businesses:can:create:bill', function(source, cb, data)
...
RegisterNetEvent("prp-businesses:create:bill:server", function(data)
...
QBCore.Functions.CreateCallback('prp-businesses:is:bill:created', function(source, cb, data)
    local pData = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('prp-businesses:get:bill:data', function(source, cb, data)
    local pData = QBCore.Functions.GetPlayer(source)
