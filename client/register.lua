...
RegisterNetEvent("prp-businesses:create:bill", function(data)
    QBCore.Functions.TriggerCallback('prp-businesses:can:create:bill', function(result)
        if not result then 
            ...
            if bill then
                ...
                TriggerServerEvent("prp-businesses:create:bill:server", {
                    job = data.job,
...
RegisterNetEvent('prp-businesses:pay:bill', function(data)
    QBCore.Functions.TriggerCallback("prp-businesses:get:bill:data", function(result)
        if not result then 
...
RegisterNetEvent('prp-businesses:delete:bill', function(data)
    QBCore.Functions.TriggerCallback("prp-businesses:is:bill:created", function(result)
        if not result then 
